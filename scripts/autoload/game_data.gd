...
const GEM_PACKS: Array[Dictionary] = [
	{"gems": 100, "cost_gems": 0, "label": "Daily Bonus", "daily": true},
	{"gems": 250, "cost_gems": 0, "label": "Battle Pass Reward", "battle_pass": true},
	{"gems": 500, "cost_gems": 400, "label": "Gem Cache"},
	{"gems": 1200, "cost_gems": 800, "label": "Gem Vault"},
	{"gems": 3000, "cost_gems": 1800, "label": "Gem Treasury"},
]
...
func get_arena(index: int) -> Dictionary:
...
func random_ai_loadout(arena_id: int, difficulty: float = 1.0) -> Dictionary:
	...
	var chassis_pool: Array = arena.chassis_pool
	var weapon_pool: Array = arena.weapon_pool
